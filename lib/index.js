...
var ReactQuill = /** @class */ (function (_super) {
    ...
    function ReactQuill(props) {
        ...
        _this.editingAreaRef = (0, react_1.createRef)();
        /*
    ...
    ReactQuill.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        ...
        return __spreadArray(__spreadArray([], this.cleanProps, true), this.dirtyProps, true).some(function (prop) {
            return !(0, isEqual_1.default)(nextProps[prop], _this.props[prop]);
        });
    };
    ...
    */
    ...
    ReactQuill.prototype.getEditingArea = function () {
        ...
        var element = this.editingAreaRef.current;
        if (!element) {
    ...
    */
    ...
    ReactQuill.prototype.render = function () {
        var _a;
        return (react_1.default.createElement("div", { id: this.props.id, style: this.props.style, key: this.state.generation, className: "quill ".concat((_a = this.props.className) !== null && _a !== void 0 ? _a : ''), onKeyPress: this.props.onKeyPress, onKeyDown: this.props.onKeyDown, onKeyUp: this.props.onKeyUp }, this.renderEditingArea()));
    };
